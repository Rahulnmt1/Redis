...
CLUSTER_USER="admin@hdfcsec.demo"
CLUSTER_PASS="HDFCsecRedis!1"
...
create_cluster redis-enterprise hdfcsec-target.local
create_cluster redis-rdi        hdfcsec-rdi.local
