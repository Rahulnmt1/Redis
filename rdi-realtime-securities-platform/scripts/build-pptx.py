...
def add_chrome(slide, slide_num, total, *, dark=False):
    ...
    add_text(slide, Inches(2.0), Inches(0.30), Inches(7), Inches(0.3),
             "  |   Redis Data Integration  ·  HDFC Securities",
    ...
    add_text(slide, Inches(0.5), Inches(7.05), Inches(8), Inches(0.3),
             "Confidential  ·  prepared for HDFC Securities",
...
add_text(s, Inches(0.6), Inches(4.75), Inches(12), Inches(0.6),
         "Real-time portfolio cache for HDFC Securities",
...
add_text(s, Inches(0.6), Inches(6.5), Inches(8), Inches(0.4),
         "Prepared for the HDFC Securities Architecture & Application team",
         size=11, color=DUSK_50, font=FONT_BODY)
...
add_text(s, Inches(0.5), Inches(1.9), Inches(6.5), Inches(0.5),
         "HDFC Securities serves millions of demat clients —\n"
...
# -----------------------------------------------------------------
# 7. Mapping HDFC Securities data to Redis
# -----------------------------------------------------------------
s = prs.slides.add_slide(blank)
add_rect(s, 0, 0, SLIDE_W, SLIDE_H, WHITE)
...
add_text(s, Inches(0.6), Inches(6.95), Inches(12), Inches(0.3),
         "Redis Data Integration  ·  prepared for HDFC Securities",
...
scenario_slide(
    ...
    watch_items=[
        ...
        "Left rail already lists 10 HDFC Sec customers",
...
scenario_slide(
    ...
    notes=(
        ...
        "  Filter:  hdfcsec.portfolio.*  → 5 streams, one per source table\n"
...
set_notes(s, (
    ...
    "the three buyer constituencies in HDFC Sec:\n"
