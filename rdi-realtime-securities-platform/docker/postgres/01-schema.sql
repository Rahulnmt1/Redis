-- =====================================================================
-- HDFC Securities - Portfolio System of Record (PostgreSQL)
-- This schema models a brokerage portfolio system similar to what a
-- broker like HDFC Securities runs on Oracle in production.
...
CREATE TABLE customer (
    ...
    client_code      VARCHAR(20)  NOT NULL UNIQUE,        -- HDFCSEC client code, e.g. HS0001234
