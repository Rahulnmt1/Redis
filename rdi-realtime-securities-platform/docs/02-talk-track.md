# RDI for HDFC Securities — Talk Track
...
| What & how         | 4–8   | RDI in one slide · Deployment · Lifecycle · HDFC mapping · 10-line YAML |
...
## Slide 7 — HDFC Sec mapping (2 min)
...
> - A psql terminal: `docker exec -it hdfcsec-postgres psql -U postgres hdfcsec`
>
...
Switch to **RDI state DB**, filter `hdfcsec.portfolio.*`:
...
per buyer constituency in HDFC Sec. Anchor the closing exchange on
them:
