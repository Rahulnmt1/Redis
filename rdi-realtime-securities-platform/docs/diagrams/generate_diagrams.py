"""
Generate professional architecture / data-flow diagrams for the the firm RDI demo.
...
# ---------------------------------------------------------------------------
with Diagram(
    "Securities & Trading Firm · RDI Demo · Architecture & Request Flow",
    ...
    with Cluster(
        "① System of Record  ·  stand-in for the firm's Oracle",
...
# ---------------------------------------------------------------------------
with Diagram(
    "Securities & Trading Firm · RDI Demo · CDC Write Path  (Postgres → Redis)",
...
# ---------------------------------------------------------------------------
with Diagram(
    "Securities & Trading Firm · RDI Demo · Dashboard Read Path  (Trader → Redis)",
